// reference
// http://blog.rystylee.com/openframeworks/openframeworks-geometry-shader
...
//    gui.add(Vertices.setup("drawVertices()", false));
    gui.add(vColor.setup("vColor", ofFloatColor(1.0, 1.0, 1.0, 1), ofFloatColor(0.0, 0.0, 0.0, 0.0), ofFloatColor(1.0, 1.0, 1.0, 1.0)));
...
//    shader.setGeometryOutputCount(6);
    ...
    img.load("blue-abstract-texture.jpg");
    // camera setting
    cam.setNearClip(0);
    cam.setFarClip(1000);
}
...
void ofApp::draw(){
    ...
    modelMatrix.rotate(100, 1.0, 0.5, 0.0);
